...
SECRET_KEY = 'django-insecure-y)v7mqi_igw!4o^9-)xyk64j2n4mn8z_r5%mh2d91=gtg70)_g'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Update this to point to the base templates directory
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
